  ...
  return (
    <View className="absolute bottom-0 pb-5 shadow-md bg-white w-full rounded-t-xl p-4">
      <View className="flex-row items-center justify-between">
        <View>
          <Text className="font-bold font-okra text-xl">Amount</Text>
      ...
      <TouchableOpacity
        ...
        <Text className="text-white font-bold text-xl font-okra">Pay Now!</Text>
      </TouchableOpacity>
    </View>
  );
};
